  ...
  return (
    <>
      <div className="bg-gradient-to-b from-[#FAFAFA] to-[#FAFAFA80] px-[100px]">
        ...
        {/* TRUCK DRIVERS CARD */}
        <div className="border flex my-11">
          ...
          <div className="border flex w-full">
            ...
            <div className="w-full bg-red-600">
              <label className="flex gap-2 text-sm">
                <span className="mt-2.5 bg-sky-600 rounded-full h-1 w-6"></span>
                <div>
              ...
              <label className="flex gap-2 text-sm">
                <span className="mt-2.5 bg-sky-500 rounded-full h-1 w-6"></span>
                <div>
                  <p className="text-xs text-[#5E6C84]">
              ...
              <label className="flex gap-2 text-sm">
                <span className="mt-2.5 bg-sky-300 rounded-full h-1 w-6"></span>
                <div>
                  <p className="text-xs text-[#5E6C84]">Drivers on route</p>
          ...
          <div className="w-full border">
            ...
            <div>
              ...
              <div class=" bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
                <div class="bg-gray-600 h-2.5 rounded-full dark:bg-gray-300 "></div>
              </div>
            </div>
          </div>
        </div>
