...
const Dashboard = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-start justify-start gap-5 w-full bg-gradient-to-b from-[#FAFAFA] to-[#FAFAFA80] px-20 py-10">
        ...
        <div className="flex flex-col md:flex-row w-full items-start justify-start border border-[#DEEBFF]">
          <div className="w-4/5 h-full">
            <ShipmentChart />
          </div>
          <div className="w-1/5">
            <div className="text-center border-[#DEEBFF] w-full grid grid-cols-1 md:grid-col-3">
        ...
        <div className="flex items-center justify-center w-full border border-[#DEEBFF] p-4">
          ...
          <div className="w-[1px] h-52 bg-[#000000] mx-32" />
          <div className="flex  flex-col items-start justify-start px-4 gap-4">
            <h1 className="font-Avenir font-extrabold text-2xl">
              Title goes here
            </h1>
            <div className="flex justify-start items-center">
              <p className="font-Avenir font-extrabold text-4xl">592</p>
              <p className="font-Avenir font-normal text-xl text-[#D0D1D2]">
                Total TL
              </p>
            </div>
