...
const ClickToView = () => {
  ...
  const {selectedIncidenceIndex, handleCardClick } = useContext(IncidenceContext);
  ...
  return (
    ...
    <div className='grid grid-cols-5'>
      ...
      <div className='col-span-1 p-5'>
        ...
        <div className='overflow-y-scroll'><IncidenceCards selectedIncidenceIndex={selectedIncidenceIndex}
          onCardClick={handleCardClick} /></div>
      </div>
